...
class UserFragment : Fragment() {
    ...
    private var gstText: TextView? = null
    ...
    override fun onCreateView(
        ...
        gstText = view.findViewById(R.id.gstText)
            ...
            .enqueue(object : Callback<UserResponse> {
                override fun onResponse(
                    ...
                    if (response.isSuccessful && response.body() != null) {
                        ...
                        // IMPORTANT
                        addressText?.text = user.fullAddress ?: ""
                        gstText?.text = user.gstin ?: ""

                    } else {
                        Toast.makeText(ctx, "Failed to fetch user data", Toast.LENGTH_SHORT).show()
                    }
                }
    ...
    private fun openEditProfileBottomSheet() {
        ...
        val editAddress = sheetView.findViewById<EditText>(R.id.editAddress)
        val editGst = sheetView.findViewById<EditText>(R.id.editGst)
        ...
        editEmail.setText(emailText?.text)
        editAddress.setText(addressText?.text)
        editGst.setText(gstText?.text)
        ...
        btnSubmit.setOnClickListener {
            ...
            val newGst = editGst.text.toString().trim().uppercase()

            if (newFirst.isEmpty() || newLast.isEmpty() || newEmail.isEmpty()) {
                Toast.makeText(ctx, "Required fields missing", Toast.LENGTH_SHORT).show()
            ...
            addressText?.text = newAddress
            gstText?.text = newGst
            userNameText?.text = "$newFirst $newLast"

            // CALL API
            updateUserProfile(newFirst, newLast, newEmail, newAddress, newGst)
    ...
    private fun updateUserProfile(
        ...
        ApiClient.api.updateUser(userId, "Bearer $token", request)
